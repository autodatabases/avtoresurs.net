...
from shop.views.product_storage_price import PSPList, PSPDetail
...
urlpatterns = [
    ...
    url(r'^api/$', PSPList.as_view(), name='psp_list'),
    url(r'^api/(?P<pk>[0-9]+)/$', PSPDetail.as_view(), name='psp_list'),
